...
function ContactForm() {
  ...
  return (
    ...
    >
      ...
      <Button type="submit" disabled={isSubmitting} className="w-full bg-navy text-white hover:bg-navy/90 transition-colors duration-200 active:scale-[0.98] uppercase font-medium disabled:opacity-70">
